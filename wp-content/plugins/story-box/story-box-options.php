...
class StoryBoxOptions {
  ...
  private function _setThemeOptions() {
    $this->themeAvailableItems        = (defined('SB_AVAILABLE_ITEMS'))         ? SB_AVAILABLE_ITEMS         : array();
    $this->themeEntranceEffects       = (defined('SB_ENTRANCE_EFFECTS'))        ? SB_ENTRANCE_EFFECTS        : array();
    $this->themeExitEffects           = (defined('SB_EXIT_EFFECTS'))            ? SB_EXIT_EFFECTS            : array();
    $this->themeDisabledMobileDevices = (defined('SB_DISABLED_MOBILE_DEVICES')) ? SB_DISABLED_MOBILE_DEVICES : array();
