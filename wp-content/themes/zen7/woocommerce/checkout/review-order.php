    ...
    <div class="col-sm-6 row-right">
        ...
        <div id="payment">
                    ...
                    if ( ! empty( $available_gateways ) ) {
                        ...
                        foreach ( $available_gateways as $gateway ) {
                            ...
                            <li class="payment_method_<?php echo $gateway->id; ?>">
                                ...
                                <label for="payment_method_<?php echo $gateway->id; ?>"><span></span><?php echo $gateway->get_title(); ?> <?php echo $gateway->get_icon(); ?></label>
                                <?php
            ...
            <div class="form-row place-order">
                ...
                echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button btn btn-default small alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
                ?>
