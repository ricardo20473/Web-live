...
<body <?php body_class(); ?>>
    ...
    <?php if(isset($zen7_data)) : ?>
        ...
        switch($zen7_data['zen_header_type']) {
            ...
            case '3':
                ...
                <div class="menu-affix"></div>
                <div class="header header-style-03" data-affix="header"> <!-- HEADER -->
                    <div class="white-half-menu">
                        <div class="container">
                            <div class="col-md-12">
                                <div class="logo">
            ...
            case '4':
                ...
                <div class="menu-affix"></div>
                <div class="header header-style-04" data-affix="header"> <!-- HEADER -->
                    <div class="white-half-menu">
                        <div class="container">
                            <div class="col-md-12">
                                <nav class="menu clearfix">
